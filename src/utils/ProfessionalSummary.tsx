...
const ProfessionalSummary: React.FC = () => {
	...
	return (
		<>
			<article ref={articleRef1} className={`mt-12 w-[85%] text-white opacity-0 ${isVisible1 && `animate-leftAnimation`}`}>
			...
			<article ref={articleRef2} className={`mt-12 w-[85%] text-white opacity-0 ${isVisible2 && `animate-rightAnimation`}`}>
				<h1 className="text-left text-xl font-semibold">
			...
			<article ref={articleRef3} className={`mt-12 w-[85%] text-white opacity-0 ${isVisible3 && `animate-leftAnimation`}`}>
				<h1 className="text-left text-xl font-semibold">
